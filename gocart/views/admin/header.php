...
<title>SwapMoto Admin<?php echo (isset($page_title))?' :: '.$page_title:''; ?></title>
			...
			<div class="nav-collapse">
				<ul class="nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo $admin_url;?>settings"><?php echo "Payment Module" ?></a></li>
                            <li><a href="<?php echo $admin_url;?>settings/emailTemplate"><?php echo "Email Template"; ?></a></li>
