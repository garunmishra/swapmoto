...
class Cart extends Front_Controller {
	...
	function product($id)
	{
		...
		$pro_condetion = array('sub_category_id'=>$data['product']->sub_category_id);
		$similar_product= $this->Product_model->get_similar_product($pro_condetion,$slimit);
		$data['similar_product'] = $similar_product;
		//print_r($similer_product);
