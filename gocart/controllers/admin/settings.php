...
class Settings extends Admin_Controller {
	...
	function addEmailTemplate($id=false)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->load->view($this->config->item('admin_folder').'/addEmailTemplate', $data);
		}
		else
		{
			...
			redirect($this->config->item('admin_folder').'/settings/emailTemplate');
		}
	}
	...
	function emailTemplate()
	{
		...
		$data['page_title']	= lang('Email Template Settings');
